  ...
  const ARTIFACTS = [
    {
      ...
      question: {
        text: "巴型土器の使われ方として、もっとも言われているものはどれ？",
        choices: [
          "装飾品",
          "投擲武器",
          "貨幣"
    ...
    },
    {
      ...
      description: "縄文時代の土器で、深い鉢型をしている土器。縄目文様のパターンの焼成の色ムラが見どころです。",
      explanation:"この土偶は明野Brothers第６世代の高学年組が、日本大会に出られるように皆で作られたものである。",
      explanation:"この深淵型土器は、火焔型土器(かえんがたどき)と呼ばれ、大きく立ち上がる突起が、燃え盛る炎のように見えることから命名されました。",
      question: {
    ...
    },
    {
      ...
      explanation:"中国大陸から伝わったころは武器として使われていましたが、やがて祭祀をする道具として、大型化していきました。お墓に入られたり、お祭りに使い埋められたりしたものが発掘調査で出てきています。。",
      question: {
